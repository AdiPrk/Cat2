...
namespace Dog {
        ...
        : mDevice{ device }, mBindings{ bindings }
    {
        ...
        if (vkCreateDescriptorSetLayout(mDevice, &descriptorSetLayoutInfo, nullptr, &mDescriptorSetLayout) != VK_SUCCESS)
        {
    ...
    bool DescriptorPool::AllocateDescriptor(const VkDescriptorSetLayout descriptorSetLayout, VkDescriptorSet& descriptor) const
    {
        ...
        if (vkAllocateDescriptorSets(mDevice, &allocInfo, &descriptor) != VK_SUCCESS)
        {
    ...
    void DescriptorPool::FreeDescriptors(std::vector<VkDescriptorSet>& descriptors) const
    {
        ...
        vkFreeDescriptorSets(mDevice, mDescriptorPool, static_cast<uint32_t>(descriptors.size()), descriptors.data());
    }
    ...
    void DescriptorWriter::Overwrite(VkDescriptorSet& set)
    {
        ...
        vkUpdateDescriptorSets(mPool.mDevice,
